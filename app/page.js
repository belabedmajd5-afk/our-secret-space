...
export default function Home() {
  ...
  const handleUpdateMessage = async (e) => {
    ...
    // This updates Firebase, which then updates the lights on BOTH phones instantly
          ...
          <form onSubmit={handleUpdateMessage} className="mt-12 w-full px-4">
            <div className="relative group">
              <input 
                ...
                className="w-full bg-transparent border-b-2 border-red-900/30 p-2 text-center text-red-700 focus:outline-none focus:border-red-600 transition-all font-mono text-sm tracking-widest placeholder:text-red-900/20"
              />
              <button 
                type="submit"
